# Full Blackjack Tournament Rules

(All rules are subject to change if so desired!)
...
(RSA, DSA, S17, Late Insurance)

- All 10 value cards can be split if so desired
